...
path2hhblits = '/usr/bin/hhblits' # Path to hhblits binary. Not required if using ScanNet_noMSA networks.
path2sequence_database = '/uniref30/UniRef30_2022_02' # Path to sequence database Not required if using ScanNet_noMSA networks. Example:
